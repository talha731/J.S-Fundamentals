var finances = [ 
 ...
 console.log('-------------------------------------------------------------------------------');
 var totalNumberOfMonths= 'Total Months:' + financesLength ;

 console.log(totalNumberOfMonths);
 //how to show the number of arrays/??

 // * The net total amount of Profit/Losses over the entire period.

 var totalProfitOrLost = (finances[0][1] + finances[1][1] + finances[2][1] + finances[3][1] + finances[4][1] + finances[5][1] + finances[6][1] + finances[7][1] +
 ...
 console.log( 'Total: ' + totalProfitOrLost );
...
let ChangesInProfitLosses = (finances[0][1] - finances[1][1] + finances[2][1] - finances[3][1] + finances[4][1] - finances[5][1] + finances[6][1] - finances[7][1] +
 ...
 console.log( 'Avarage Change: ' + ChangesInProfitLosses/86
     );
...
// * The greatest increase in profits (date and amount) over the entire period.
 ...
 let greatestIncreaseInProfit = finances[0];
  ...
  let greatestDecreaseInProfit = finances[0];
  for (var i=0;i<finances.length;i++) {
    greatestDecreaseInProfit = finances[i];
  }
  console.log( 'Greatest Decrease In Profit: ' + greatestDecreaseInProfit);
